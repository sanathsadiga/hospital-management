                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                ...
                                <td >
                                 <div style="display:flex;justify-content: center;">
                                <a href="?action=addprescription&id='.$pid.'" class="non-style-link"><button  class="btn-primary-soft btn "  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Add Prescription</font></button></a>
                                </div>
                                </td>
    ...
    if($_GET){
        ...
        if($action === "addprescription"){
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <a class="close" href="?action=view&id='.$pid.'">&times;</a>
                        <div class="content"> 
                        </div>
                        <div style="display: flex;justify-content: center;">
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <textarea rows="20" cols="60" style="display: justify-content: center; resize: none;"> </textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <a href="patient.php"><input type="button" value="Update" class="login-btn btn-primary-soft btn" ></a>
                                </td>
                            </tr>
                        ';
            }
