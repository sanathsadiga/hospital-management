            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn   menu-active ">
                        <a href="Reviews and feedback.php" class="non-style-link-menu  non-style-link-menu-active"><div><p class="menu-text">Reviews</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn  ">
                        <a href="query.php" class="non-style-link-menu "><div><p class="menu-text">Report</p></a></div>
                    </td>
                </tr>
                       ...
                       <center>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $result= $database->query("select * from reviews;");
